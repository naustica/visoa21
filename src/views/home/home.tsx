...
export default class Home extends Component<Props, State> {
  ...
  private updateFilter = (filterString: string): void => {
    ...
    if (!filter.includes(filterString)) {
      ...
      newFilter = filter.concat(filterString)

    } else {
      newFilter = filter.filter((e: any) => e !== filterString)
  ...
  private getBeansCount = (): Array<number> => {
    ...
    const grouped_df_not_known = this.applyFilter("Recherche fehlt").concat(this.applyFilter(""))
    const grouped_df_missing = this.applyFilter("FALSE")
    ...
    return [beansCountExisting, beansCountnotKnown, beansCountMissing]
  }
  ...
  private renderBeans = (): ComponentChild => {
    ...
    for(var i = 1; i < Array.from(Array(NUMBER_OF_INSTITUTIONS)).length; i++) {
      ...
      components.push(
        ...
        <path fill={color} d="M13.9866 2.60586C12.0302 0.649467 0.654742 12.0408 2.61114 13.9814C4.56754 15.922 8.70121 14.9753 11.8409 11.8199C14.9806 8.68016 15.943 4.54648 13.9866 2.60586Z"/>
        <path fill={color} d="M12.3932 1.01267C10.4368 -0.943728 6.30311 0.018695 3.1634 3.17418C0.0237033 6.31388 -0.938717 10.4476 1.0019 12.404C1.9801 13.3822 1.80655 9.86379 5.82978 5.84055C9.66369 2.00665 13.3714 1.99087 12.3932 1.01267Z"/>
        </svg>
      )
    }
  ...
  private renderMap = (): ComponentChild => {
    ...
    if (grouped_df.length > 0) {
      ...
      DE_BY = this.findObjectByKey(grouped_df, 'bundesland', 'Bayern')
      DE_BE = this.findObjectByKey(grouped_df, 'bundesland', 'Berlin')
      DE_BB = this.findObjectByKey(grouped_df, 'bundesland', 'Brandenburg')
      DE_HB = this.findObjectByKey(grouped_df, 'bundesland', 'Bremen')
      DE_HH = this.findObjectByKey(grouped_df, 'bundesland', 'Hamburg')
      DE_HE = this.findObjectByKey(grouped_df, 'bundesland', 'Hessen')
      DE_MV = this.findObjectByKey(grouped_df, 'bundesland', 'Mecklenburg-Vorpommern')
      DE_NI = this.findObjectByKey(grouped_df, 'bundesland', 'Niedersachsen')
      DE_NW = this.findObjectByKey(grouped_df, 'bundesland', 'Nordrhein-Westfalen')
      DE_RP = this.findObjectByKey(grouped_df, 'bundesland', 'Rheinland-Pfalz')
      DE_SL = this.findObjectByKey(grouped_df, 'bundesland', 'Saarland')
      DE_SN = this.findObjectByKey(grouped_df, 'bundesland', 'Sachsen')
      DE_ST = this.findObjectByKey(grouped_df, 'bundesland', 'Sachsen-Anhalt')
      DE_SH = this.findObjectByKey(grouped_df, 'bundesland', 'Schleswig-Holstein')
      DE_TH = this.findObjectByKey(grouped_df, 'bundesland', 'Thüringen')
    ...
    return (
      <svg
        ...
        <path
           ...
           fill={DE_BW > 10 ? selectedColor3 : DE_BW > 5 ? selectedColor2 : DE_BW > 0 ? selectedColor : unselectedColor}
           id="DE-BW" />
        <text transform="matrix(1.5 0 0 1.5 190 660)" fill="black">{DE_BW > 0 ? DE_BW : null}</text>
        <path
           ...
           title="Bavaria"
           fill={DE_BY > 10 ? selectedColor3 : DE_BY > 5 ? selectedColor2 : DE_BY > 0 ? selectedColor : unselectedColor}
           id="DE-BY" />
        <text transform="matrix(1.5 0 0 1.5 350 630)" fill="black">{DE_BY > 0 ? DE_BY : null}</text>
        <path
           ...
           title="Berlin"
           fill={DE_BE > 10 ? selectedColor3 : DE_BE > 5 ? selectedColor2 : DE_BE > 0 ? selectedColor : unselectedColor}
           id="DE-BE" />
        <text transform="matrix(1.5 0 0 1.5 470 280)" fill="black">{DE_BE > 0 ? DE_BE : null}</text>
        <path
           ...
           title="Brandenburg"
           fill={DE_BB > 10 ? selectedColor3 : DE_BB > 5 ? selectedColor2 : DE_BB > 0 ? selectedColor : unselectedColor}
           id="DE-BB" />
        <text transform="matrix(1.5 0 0 1.5 500 320)" fill="black">{DE_BB > 0 ? DE_BB : null}</text>
        <path
           ...
           title="Bremen"
           fill={DE_HB > 10 ? selectedColor3 : DE_HB > 5 ? selectedColor2 : DE_HB > 0 ? selectedColor : unselectedColor}
           id="DE-HB" />
        <text transform="matrix(1.5 0 0 1.5 180 210)" fill="black">{DE_HB > 0 ? DE_HB : null}</text>
        <path
           ...
           title="Hamburg"
           fill={DE_HH > 10 ? selectedColor3 : DE_HH > 5 ? selectedColor2 : DE_HH > 0 ? selectedColor : unselectedColor}
           id="DE-HH" />
        <text transform="matrix(1.5 0 0 1.5 255 170)" fill="black">{DE_HH > 0 ? DE_HH : null}</text>
        <path
           ...
           title="Hesse"
           fill={DE_HE > 10 ? selectedColor3 : DE_HE > 5 ? selectedColor2 : DE_HE > 0 ? selectedColor : unselectedColor}
           id="DE-HE" />
        <text transform="matrix(1.5 0 0 1.5 180 470)" fill="black">{DE_HE > 0 ? DE_HE : null}</text>
        <path
           ...
           fill={DE_MV > 10 ? selectedColor3 : DE_MV > 5 ? selectedColor2 : DE_MV > 0 ? selectedColor : unselectedColor}
           id="DE-MV" />
        <text transform="matrix(1.5 0 0 1.5 400 145)" fill="black">{DE_MV > 0 ? DE_MV : null}</text>
        <path
           ...
           title="Lower Saxony"
           fill={DE_NI > 10 ? selectedColor3 : DE_NI > 5 ? selectedColor2 : DE_NI > 0 ? selectedColor : unselectedColor}
           id="DE-NI" />
        <text transform="matrix(1.5 0 0 1.5 210 250)" fill="black">{DE_NI > 0 ? DE_NI : null}</text>
        <path
           ...
           fill={DE_NW > 10 ? selectedColor3 : DE_NW > 5 ? selectedColor2 : DE_NW > 0 ? selectedColor : unselectedColor}
           id="DE-NW" />
        <text transform="matrix(1.5 0 0 1.5 80 380)" fill="black">{DE_NW > 0 ? DE_NW : null}</text>
        <path
           ...
           fill={DE_RP > 10 ? selectedColor3 : DE_RP > 5 ? selectedColor2 : DE_RP > 0 ? selectedColor : unselectedColor}
           id="DE-RP" />
        <text transform="matrix(1.5 0 0 1.5 60 530)" fill="black">{DE_RP > 0 ? DE_RP : null}</text>
        <path
           ...
           title="Saarland"
           fill={DE_SL > 10 ? selectedColor3 : DE_SL > 5 ? selectedColor2 : DE_SL > 0 ? selectedColor : unselectedColor}
           id="DE-SL" />
        <text transform="matrix(1.5 0 0 1.5 55 595)" fill="black">{DE_SL > 0 ? DE_SL : null}</text>
        <path
           ...
           title="Saxony"
           fill={DE_SN > 10 ? selectedColor3 : DE_SN > 5 ? selectedColor2 : DE_SN > 0 ? selectedColor : unselectedColor}
           id="DE-SN" />
        <text transform="matrix(1.5 0 0 1.5 460 430)" fill="black">{DE_SN > 0 ? DE_SN : null}</text>
        <path
           ...
           title="Saxony-Anhalt"
           fill={DE_ST > 10 ? selectedColor3 : DE_ST > 5 ? selectedColor2 : DE_ST > 0 ? selectedColor : unselectedColor}
           id="DE-ST" />
        <text transform="matrix(1.5 0 0 1.5 345 330)" fill="black">{DE_ST > 0 ? DE_ST : null}</text>
        <path
           ...
           fill={DE_SH > 10 ? selectedColor3 : DE_SH > 5 ? selectedColor2 : DE_SH > 0 ? selectedColor : unselectedColor}
           id="DE-SH" />
        <text transform="matrix(1.5 0 0 1.5 230 110)" fill="black">{DE_SH > 0 ? DE_SH : null}</text>
        <path
           ...
           title="Thuringia"
           fill={DE_TH > 10 ? selectedColor3 : DE_TH > 5 ? selectedColor2 : DE_TH > 0 ? selectedColor : unselectedColor}
           id="DE-TH" />
        <text transform="matrix(1.5 0 0 1.5 310 450)" fill="black">{DE_TH > 0 ? DE_TH : null}</text>
      </svg>
    )
  }
